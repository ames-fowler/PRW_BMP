...
z=raster("processed_data/NED_PRW")
plot(z)
writeRaster(z,"processed_data/NED_PRW.tiff")

?writeRaster
# Pitremove
system("mpiexec -n 8 pitremove -z processed_data/NED_PRW.tiff -fel processed_data/NED_PRW.tiff")
